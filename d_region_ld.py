...
variables.set("SCRIPT_NAME", "d_region_ld")
...
try:
    ...
    query = """
            INSERT INTO bhatbhateni_tgt.region_dim
            (id,region_desc,country_id,record_active)
            select id,region_desc,country_id,1 from 
            bhatbhateni_tmp.region
    """
    execute_query(conn, query)
