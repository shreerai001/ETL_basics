...
>>> pd.read_excel('csv.xlsx', index_col=0)  # doctest: +SKIP
       Name  Value
0   string1      1
1   string2      2
2  #Comment      3

>>> pd.read_excel(open('csv.xlsx', 'rb'),
...
>>> pd.read_excel('csv.xlsx', index_col=None, header=None)  # doctest: +SKIP
     0         1      2
0  NaN      Name  Value
1  0.0   string1      1
2  1.0   string2      2
...
>>> pd.read_excel('csv.xlsx', index_col=0,
...
>>> pd.read_excel('csv.xlsx', index_col=0, comment='#')  # doctest: +SKIP
      Name  Value
0  string1    1.0
1  string2    2.0
2     None    NaN
