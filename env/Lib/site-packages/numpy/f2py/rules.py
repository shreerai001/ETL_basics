...
PyMODINIT_FUNC PyInit_#modulename#(void) {
    ...
    for(i=0;f2py_routine_defs[i].name!=NULL;i++) {
        csv = PyFortranObject_NewAsAttr(&f2py_routine_defs[i]);
        PyDict_SetItemString(d, f2py_routine_defs[i].name, csv);
        Py_DECREF(csv);
    }
#initf2pywraphooks#
#initf90modhooks#
...
rout_rules = [
        ...
        'initf2pywraphook': {l_not(l_or(ismoduleroutine, isdummyroutine)): '''
    {
      ...
      csv = F2PyCapsule_FromVoidPtr((void*)#F_FUNC#(#name_lower#,#NAME#),NULL);
      PyObject_SetAttrString(o,"_cpointer", csv);
      Py_DECREF(csv);
