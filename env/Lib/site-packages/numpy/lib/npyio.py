...
def load(file, mmap_mode=None, allow_pickle=False, fix_imports=True,
    ...
    >>> np.save('/csv/123', np.array([[1, 2, 3], [4, 5, 6]]))
    >>> np.load('/csv/123.npy')
    array([[1, 2, 3],
           [4, 5, 6]])
    ...
    >>> b=np.array([1, 2])
    >>> np.savez('/csv/123.npz', a=a, b=b)
    >>> data = np.load('/csv/123.npz')
    >>> data['a']
    array([[1, 2, 3],
           [4, 5, 6]])
    >>> data['b']
    ...
    >>> X = np.load('/csv/123.npy', mmap_mode='r')
    >>> X[1, :]
    memmap([4, 5, 6])
...
def savez_compressed(file, *args, **kwds):
    ...
    >>> np.savez_compressed('/csv/123', a=test_array, b=test_vector)
    >>> loaded = np.load('/csv/123.npz')
